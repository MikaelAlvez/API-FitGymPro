...
const checkinSchema = zod_1.z.object({
    ...
    caption: zod_1.z.string().min(1, 'Legenda obrigatória'),
    notes: zod_1.z.string().optional(),
    location: zod_1.z.string().optional(),
    photoStart: zod_1.z.string().optional(),
});
const checkoutSchema = zod_1.z.object({
    caption: zod_1.z.string().min(1, 'Legenda obrigatória'),
    notes: zod_1.z.string().optional(),
    notesEnd: zod_1.z.string().optional(),
    location: zod_1.z.string().optional(),
    photoEnd: zod_1.z.string().optional(),
});
const updateSessionSchema = zod_1.z.object({
    caption: zod_1.z.string().min(1).optional(),
    captionEnd: zod_1.z.string().optional().nullable(),
    notes: zod_1.z.string().optional().nullable(),
    notesEnd: zod_1.z.string().optional().nullable(),
    location: zod_1.z.string().optional().nullable(),
});
const removeFile = (urlPath) => {
    if (!urlPath)
        return;
    const filepath = path_1.default.join(process.cwd(), 'src', urlPath.replace(/^\//, ''));
